...
- **Recomendación**: documenta los paquetes que vayas añadiendo, su API pública y cómo se consumen desde `uis/`, `agents/` y `workflows/`. En este monorepo no existe la carpeta `apps/`; las interfaces viven en `uis/`.
